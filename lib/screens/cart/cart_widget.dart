...
class CartWidget extends ConsumerStatefulWidget {
  const CartWidget({Key? key, required this.q, required this.cartModel})
      : super(key: key);
  final int q;
  final CartModel cartModel;
  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _CartWidgetState(q, cartModel);
}

class _CartWidgetState extends ConsumerState {
  final _quantityTextController = TextEditingController();
  final int q;
  final CartModel cartModel;

  _CartWidgetState(this.q, this.cartModel);
  @override
  void initState() {
    _quantityTextController.text = q.toString();
    super.initState();
  }
