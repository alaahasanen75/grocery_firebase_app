...
import 'package:geogrcy_firebase/models/wishlist_model.dart';
...
class WishlistWidget extends ConsumerWidget {
  WishlistWidget({Key? key, required this.wishlistModel}) : super(key: key);
  final WishlistModel? wishlistModel;

// ref.read(counterProvider.notifier).state++,
  @override
  Widget build(BuildContext context, ref) {
    final productProvider = ref.watch(product);
